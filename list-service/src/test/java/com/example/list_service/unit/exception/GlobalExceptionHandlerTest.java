package com.example.list_service.unit.exception;

import static org.assertj.core.api.Assertions.assertThat;

import com.example.list_service.exception.GlobalExceptionHandler;
...
public class GlobalExceptionHandlerTest {
  ...
  void handleResourceNotFoundException_returnsNotFound() {
    ...
    String exceptionMessage = "List 999 not found";
